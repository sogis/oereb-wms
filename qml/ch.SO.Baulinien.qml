...
<qgis labelsEnabled="0" readOnly="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyMaxScale="1" maxScale="0" version="3.16.6-Hannover" minScale="100000000" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyAlgorithm="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" forceraster="0" symbollevels="0">
    <rules key="{87c4bcee-5a6f-4d56-bd0d-4b723a6b1c0f}">
      <rule key="{21c37775-e0ea-4ecc-98dd-65013cc779a6}" label="Baulinie Strasse kantonal" symbol="0" filter="&quot;artcode&quot; = '7110'"/>
      <rule key="{96b96b78-675e-41af-b9b8-6d030f292247}" label="Vorbaulinie kantonal" symbol="1" filter="&quot;artcode&quot; = '7120'"/>
      <rule key="{4df96219-8314-4f51-bf9d-bca8e41d7016}" label="Gestaltungsbaulinie kantonal" symbol="2" filter="&quot;artcode&quot; = '7130'"/>
      <rule key="{9cd39734-ea30-4dc0-abb5-eb551f876e17}" label="Rückwärtige Baulinie kantonal" symbol="3" filter="&quot;artcode&quot; = '7140'"/>
      <rule key="{07dcc5bd-4636-47a6-b249-fa3743080e21}" label="Baulinie Infrastruktur kantonal" symbol="4" filter="&quot;artcode&quot; = '7150'"/>
      <rule key="{c3f747bf-6dcb-44e1-b748-c53a38471114}" label="weitere nationale und kantonale Baulinien" symbol="5" filter="&quot;artcode&quot; = '7190'"/>
      <rule key="{d2587a00-879f-4c12-9eac-b36d67adcc25}" label="Baulinie Strasse" symbol="6" filter="&quot;artcode&quot; = '7200'"/>
      <rule key="{441fcca5-7351-4a6a-b1b7-13ee006d5f78}" label="Vorbaulinie" symbol="7" filter="&quot;artcode&quot; = '7210'"/>
      <rule key="{41a89bde-0764-4043-818a-57277574692f}" label="Gestaltungsbaulinie" symbol="8" filter="&quot;artcode&quot; = '7220'"/>
      <rule key="{ea45cbd8-4dab-41d3-a5f4-fc12d7c4746a}" label="Rückwärtige Baulinie" symbol="9" filter="&quot;artcode&quot; = '7230'"/>
      <rule key="{d76cb5b9-9c06-42b9-bd9a-b3319cd33df9}" label="Baulinie Infrastruktur" symbol="10" filter="&quot;artcode&quot; = '7240'"/>
      <rule key="{c0513e4d-1f79-4a04-b4cf-7bfd91fb5188}" label="Baulinie Hecke" symbol="11" filter="&quot;artcode&quot; = '7260'"/>
      <rule key="{513fe77b-7cb9-4b99-aeec-c447aed306f8}" label="Baulinie Gewässer" symbol="12" filter="&quot;artcode&quot; = '7270'"/>
      <rule key="{b0d18754-955a-453d-b95a-922a05727778}" label="Immissionsstreifen" symbol="13" filter="&quot;artcode&quot; = '7280'"/>
      <rule key="{3ce97850-d1c6-4e09-bb5f-4dade318e26a}" label="weitere kommunale Baulinien" symbol="14" filter="&quot;artcode&quot; = '7290'" description="7291-7299 weitere kommunale Baulinien"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" type="line" name="10" clip_to_extent="1" alpha="1">
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol force_rhr="0" type="line" name="11" clip_to_extent="1" alpha="1">
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol force_rhr="0" type="line" name="12" clip_to_extent="1" alpha="1">
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol force_rhr="0" type="line" name="13" clip_to_extent="1" alpha="1">
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol force_rhr="0" type="line" name="14" clip_to_extent="1" alpha="1">
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol force_rhr="0" type="line" name="7" clip_to_extent="1" alpha="1">
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol force_rhr="0" type="line" name="8" clip_to_extent="1" alpha="1">
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol force_rhr="0" type="line" name="9" clip_to_extent="1" alpha="1">
        <layer pass="0" enabled="1" class="SimpleLine" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="thema" width="318" hidden="0"/>
