...
<qgis simplifyDrawingHints="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" labelsEnabled="1" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" version="3.16.5-Hannover" simplifyAlgorithm="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="RuleRenderer">
    <rules key="{87c4bcee-5a6f-4d56-bd0d-4b723a6b1c0f}">
      <rule key="{21c37775-e0ea-4ecc-98dd-65013cc779a6}" label="Baulinie Strasse kantonal" symbol="0" filter="substr(&quot;artcode&quot;,1,3) = 711"/>
      <rule key="{96b96b78-675e-41af-b9b8-6d030f292247}" label="Vorbaulinie kantonal" symbol="1" filter="substr(&quot;artcode&quot;,1,3) = 712"/>
      <rule key="{4df96219-8314-4f51-bf9d-bca8e41d7016}" label="Gestaltungsbaulinie kantonal" symbol="2" filter="substr(&quot;artcode&quot;,1,3) = 713"/>
      <rule key="{9cd39734-ea30-4dc0-abb5-eb551f876e17}" label="Rückwärtige Baulinie kantonal" symbol="3" filter="substr(&quot;artcode&quot;,1,3) = 714"/>
      <rule key="{07dcc5bd-4636-47a6-b249-fa3743080e21}" label="Baulinie Infrastruktur kantonal" symbol="4" filter="substr(&quot;artcode&quot;,1,3) = 715"/>
      <rule key="{c3f747bf-6dcb-44e1-b748-c53a38471114}" label="weitere nationale und kantonale Baulinien" symbol="5" filter="substr(&quot;artcode&quot;,1,3) = 719"/>
      <rule key="{d2587a00-879f-4c12-9eac-b36d67adcc25}" label="Baulinie Strasse" symbol="6" filter="substr(&quot;artcode&quot;,1,3) = 720"/>
      <rule key="{441fcca5-7351-4a6a-b1b7-13ee006d5f78}" label="Vorbaulinie" symbol="7" filter="substr(&quot;artcode&quot;,1,3) = 721"/>
      <rule key="{41a89bde-0764-4043-818a-57277574692f}" label="Gestaltungsbaulinie" symbol="8" filter="substr(&quot;artcode&quot;,1,3) = 722"/>
      <rule key="{ea45cbd8-4dab-41d3-a5f4-fc12d7c4746a}" label="Rückwärtige Baulinie" symbol="9" filter="substr(&quot;artcode&quot;,1,3) = 723"/>
      <rule key="{d76cb5b9-9c06-42b9-bd9a-b3319cd33df9}" label="Baulinie Infrastruktur" symbol="10" filter="substr(&quot;artcode&quot;,1,3) = 724"/>
      <rule key="{c0513e4d-1f79-4a04-b4cf-7bfd91fb5188}" label="Baulinie Hecke" symbol="11" filter="substr(&quot;artcode&quot;,1,3) = 726"/>
      <rule key="{513fe77b-7cb9-4b99-aeec-c447aed306f8}" label="Baulinie Gewässer" symbol="12" filter="substr(&quot;artcode&quot;,1,3) = 727"/>
      <rule key="{b0d18754-955a-453d-b95a-922a05727778}" label="Immissionsstreifen" symbol="13" filter="substr(&quot;artcode&quot;,1,3) = 728"/>
      <rule key="{3ce97850-d1c6-4e09-bb5f-4dade318e26a}" label="weitere kommunale Baulinien" symbol="14" description="7291-7299 weitere kommunale Baulinien" filter="substr(&quot;artcode&quot;,1,3) = 729"/>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" name="1" type="line" force_rhr="0" alpha="1">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="153,255,255,255"/>
      ...
      <symbol clip_to_extent="1" name="10" type="line" force_rhr="0" alpha="1">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol clip_to_extent="1" name="11" type="line" force_rhr="0" alpha="1">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol clip_to_extent="1" name="12" type="line" force_rhr="0" alpha="1">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol clip_to_extent="1" name="13" type="line" force_rhr="0" alpha="1">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol clip_to_extent="1" name="14" type="line" force_rhr="0" alpha="1">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol clip_to_extent="1" name="2" type="line" force_rhr="0" alpha="1">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="204,102,255,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.7"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol clip_to_extent="1" name="3" type="line" force_rhr="0" alpha="1">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="102,102,204,255"/>
          <prop k="line_style" v="dash dot"/>
          <prop k="line_width" v="0.7"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol clip_to_extent="1" name="4" type="line" force_rhr="0" alpha="1">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="255,204,204,255"/>
          <prop k="line_style" v="dash dot"/>
          <prop k="line_width" v="0.7"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol clip_to_extent="1" name="5" type="line" force_rhr="0" alpha="1">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="102,102,255,255"/>
          <prop k="line_style" v="dash dot"/>
          <prop k="line_width" v="0.7"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol clip_to_extent="1" name="6" type="line" force_rhr="0" alpha="1">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol clip_to_extent="1" name="7" type="line" force_rhr="0" alpha="1">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol clip_to_extent="1" name="8" type="line" force_rhr="0" alpha="1">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
      ...
      <symbol clip_to_extent="1" name="9" type="line" force_rhr="0" alpha="1">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="aussage" type="field" width="369" hidden="0"/>
      <column name="thema" type="field" width="318" hidden="0"/>
      <column name="sub_thema" type="field" width="364" hidden="0"/>
