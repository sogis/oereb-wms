...
<qgis simplifyDrawingHints="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" labelsEnabled="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" version="3.16.5-Hannover" simplifyAlgorithm="0" simplifyDrawingTol="1">
  <flags>
  ...
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="RuleRenderer">
    <rules key="{4f8ea2a5-dd2d-48d0-9c4c-55147a6beee7}">
      <rule key="{e0a03100-47d6-41ae-b06a-442930ee5e07}" label="erhaltenswerter Einzelbaum" symbol="0" filter="&quot;artcode&quot; = 811"/>
      <rule key="{b5d44db3-2114-44de-b239-14e2ea838064}" label="schützenswertes Kulturobjekt" symbol="1" filter="&quot;artcode&quot; = 822"/>
      <rule key="{5869ab15-47a2-47c1-bee6-2efad19eb230}" label="erhaltenswertes Kulturobjekt" symbol="2" filter="&quot;artcode&quot; = 823"/>
      <rule key="{61ac1ad2-6783-4d71-878f-7847c0b13334}" label="weitere punktbezogene Festlegungen NP" symbol="3" filter="&quot;artcode&quot; = 899"/>
    </rules>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format reverseDirectionSymbol="0" decimals="3" wrapChar="" autoWrapLength="0" placeDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" multilineAlign="3" useMaxLineLengthForAutoWrap="1" plussign="0" rightDirectionSymbol=">" addDirectionSymbol="0"/>
      <placement centroidInside="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleIn="25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" centroidWhole="0" geometryGenerator="" polygonPlacementFlags="2" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" offsetUnits="MM" placement="6" xOffset="0" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" geometryGeneratorType="PointGeometry" repeatDistance="0" maxCurvedCharAngleOut="-25" distUnits="MM" lineAnchorType="0" overrunDistance="0" yOffset="0" quadOffset="4" offsetType="1" placementFlags="10" overrunDistanceUnit="MM" priority="5" dist="1" repeatDistanceUnits="MM" layerType="PointGeometry"/>
  ...
  <DiagramLayerSettings placement="0" showAll="1" zIndex="0" linePlacementFlags="18" dist="0" obstacle="0" priority="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="sub_thema" type="field" width="491" hidden="0"/>
