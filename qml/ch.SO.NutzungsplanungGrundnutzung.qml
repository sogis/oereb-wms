...
<qgis simplifyDrawingHints="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="0" labelsEnabled="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" version="3.16.5-Hannover" simplifyAlgorithm="0" simplifyDrawingTol="1">
  <flags>
  ...
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="1" type="RuleRenderer">
    <rules key="{5926142d-eb7f-4035-817c-284bc8a0d327}">
      <rule key="{11e825c1-c55c-4d7b-b232-55a6e0b7da99}" label="Wohnzone 1 G" symbol="0" filter="&quot;artcode&quot; = '110'"/>
      <rule key="{1ff8bb29-70a1-4b57-a220-4a0a2e090165}" label="Wohnzone 2 G" symbol="1" filter="&quot;artcode&quot; = '111'"/>
      <rule key="{65481aa7-f395-49a9-bb79-265e794f1d2a}" label="Wohnzone 3 G" symbol="2" filter="&quot;artcode&quot; = '112'"/>
      <rule key="{3cc03711-b722-4d3e-b087-51554fbb1ed6}" label="Wohnzone 4 G" symbol="3" filter="&quot;artcode&quot; = '113'"/>
      <rule key="{51d4caea-3cc9-4b15-a656-3b95d6e0cbaf}" label="Wohnzone 5 G" symbol="4" filter="&quot;artcode&quot; = '114'"/>
      <rule key="{13398e93-e7a2-483f-89b4-c470ffa5be54}" label="Wohnzone 6 G" symbol="5" filter="&quot;artcode&quot; = '115'"/>
      <rule key="{3eeae0cc-d609-4bbe-8da7-617128492304}" label="Wohnzone 7 G und grösser" symbol="6" filter="&quot;artcode&quot; = '116'"/>
      <rule key="{837bd639-f9c8-435d-b47e-f99032dd8a24}" label="Zone für Terrassenhäuser / Terrassensiedlung" symbol="7" filter="&quot;artcode&quot; = '117'"/>
      <rule key="{d63f1bc7-d2a6-43b1-9f1f-cad8f05a7926}" label="Gewerbezone ohne Wohnen" symbol="8" filter="&quot;artcode&quot; = '120'"/>
      <rule key="{8181b323-fef6-4de8-80ac-cc75fbc8e02a}" label="Industriezone" symbol="9" filter="&quot;artcode&quot; = '121'"/>
      <rule key="{6cee2b2a-d1b8-458f-88b8-79e750bf67d7}" label="Arbeitszone" symbol="10" filter="&quot;artcode&quot; = '122'"/>
      <rule key="{5ab31b74-9f2c-4d9c-8f17-cb9f5268656b}" label="Gewerbezone mit Wohnen / Mischzone" symbol="11" filter="&quot;artcode&quot; = '130'"/>
      <rule key="{5f31771c-5a31-4820-9a78-90fc5217a06c}" label="Gewerbezone mit Wohnen / Mischzone 2 G" symbol="12" filter="&quot;artcode&quot; = '131'"/>
      <rule key="{1773fb3c-e76a-48be-b627-d3cd63a2b655}" label="Gewerbezone mit Wohnen / Mischzone 3 G" symbol="13" filter="&quot;artcode&quot; = '132'"/>
      <rule key="{f0fd7d3e-b8c6-402b-92d6-7468a528f6fb}" label="Gewerbezone mit Wohnen / Mischzone 4 G und grösser" symbol="14" filter="&quot;artcode&quot; = '133'"/>
      <rule key="{f90f7926-0e59-4122-b2be-fb99b5c391f5}" label="Zone für publikumsintensive Anlagen" symbol="15" filter="&quot;artcode&quot; = '134'"/>
      <rule key="{2e59fc4e-51a7-488b-a0e3-7ff1f15da5ca}" label="Kernzone" symbol="16" filter="&quot;artcode&quot; = '140'"/>
      <rule key="{39b37d57-7915-4cdc-b8ae-88fe1db396cd}" label="Zentrumszone" symbol="17" filter="&quot;artcode&quot; = '141'"/>
      <rule key="{ecf0d49c-c19c-47b1-8c53-b25fa03a1938}" label="Erhaltungszone" symbol="18" filter="&quot;artcode&quot; = '142'"/>
      <rule key="{a631c670-aa65-44db-b0af-d57ac5122365}" label="Zone für öffentliche Bauten" symbol="19" filter="&quot;artcode&quot; = '150'"/>
      <rule key="{e1e07a3d-b217-412a-af99-880adede8ca3}" label="Zone für öffentliche Anlagen" symbol="20" filter="&quot;artcode&quot; = '151'"/>
      <rule key="{62d7d41d-0064-4f94-a52e-bfad840171de}" label="Grün- und Freihaltezone innerhalb Bauzone" symbol="21" filter="&quot;artcode&quot; = '160'"/>
      <rule key="{e1afb34b-f62f-48e8-a35e-feb3a59a7fdf}" label="kommunale Uferschutzzone innerhalb Bauzone" symbol="22" filter="&quot;artcode&quot; = '161'"/>
      <rule key="{e4bcddfe-b79f-4035-8f9b-2f1e4686bd65}" label="Landwirtschaftliche Kernzone" symbol="23" filter="&quot;artcode&quot; = '162'"/>
      <rule key="{1ce8cc3e-c45a-48a7-9a7e-1da21a9c7e31}" label="Weilerzone" symbol="24" filter="&quot;artcode&quot; = '163'"/>
      <rule key="{b5d767d0-0bcc-48a8-a95d-f262d96bbb5a}" label="weitere eingeschränkte Bauzonen" symbol="25" filter="&quot;artcode&quot; = '169'"/>
      <rule key="{059298b1-f32c-4b35-aa5f-bf4377d139da}" label="Zone für Freizeit und Erholung" symbol="26" filter="&quot;artcode&quot; = '170'"/>
      <rule key="{3f407db7-85c0-46f5-a8b1-3f05535b133f}" label="Spezialzone" symbol="27" filter="&quot;artcode&quot; = '190'"/>
      <rule key="{9ed089cb-a0cf-42f4-8df5-8c1fc59345aa}" label="spezielle Landwirtschaftszone" symbol="28" filter="&quot;artcode&quot; = '220'"/>
      <rule key="{3847f4b1-9f8b-4755-bf8a-a0f8ceb346ff}" label="Rebbauzone" symbol="29" filter="&quot;artcode&quot; = '230'"/>
      <rule key="{c80cc658-a947-487c-8b9b-6062611d8f6e}" label="weitere Landwirtschaftszonen" symbol="30" filter="&quot;artcode&quot; = '290'"/>
      <rule key="{d488f8c0-1c6c-497b-a160-fa725d398bae}" label="kommunale Naturschutzzone" symbol="31" filter="&quot;artcode&quot; = '310'"/>
      <rule key="{390a58c6-0307-4271-bed2-bc935900bbe0}" label="Waldrandschutzzone" symbol="32" filter="&quot;artcode&quot; = '311'"/>
      <rule key="{69abcac3-9c1b-4f54-a5dd-8407f43099a0}" label="weitere Schutzzonen für Lebensräume und Landschaften" symbol="33" filter="&quot;artcode&quot; = '319'"/>
      <rule key="{06e1603c-63ef-4e7e-bc6d-114b3fdb5993}" label="weitere Schutzzonen ausserhalb Bauzonen" symbol="34" filter="&quot;artcode&quot; = '390'"/>
      <rule key="{42e86591-798f-446c-b52c-42aa10b57318}" label="Golfzone" symbol="35" filter="&quot;artcode&quot; = '490'"/>
      <rule key="{e8b1d3e6-36db-4c0d-9262-b7120c0c3324}" label="Abbauzone" symbol="36" filter="&quot;artcode&quot; = '491'"/>
      <rule key="{1c75a107-b149-47a1-b9c2-9bd2b2825557}" label="Deponiezone" symbol="37" filter="&quot;artcode&quot; = '492'"/>
      <rule key="{ea892c2c-fdc0-44cf-b71a-eade868cc2e1}" label="weitere Bauzonen nach Art. 18 RPG ausserhalb Bauzonen" symbol="38" filter="&quot;artcode&quot; = '499'"/>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" name="10" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="255,102,255,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol clip_to_extent="1" name="11" type="fill" force_rhr="0" alpha="1">
        <layer class="LinePatternFill" pass="0" enabled="1" locked="0">
          <prop k="angle" v="45"/>
          <prop k="color" v="255,204,255,255"/>
          <prop k="distance" v="4"/>
        ...
        <layer class="LinePatternFill" pass="0" enabled="1" locked="0">
          ...
          <symbol clip_to_extent="1" name="@11@1" type="line" force_rhr="0" alpha="1">
            <layer class="SimpleLine" pass="0" enabled="1" locked="0">
              <prop k="align_dash_pattern" v="0"/>
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
              ...
              <prop k="draw_inside_polygon" v="0"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="255,255,51,255"/>
              <prop k="line_style" v="solid"/>
              <prop k="line_width" v="2"/>
              <prop k="line_width_unit" v="MM"/>
              <prop k="offset" v="0"/>
      ...
      <symbol clip_to_extent="1" name="12" type="fill" force_rhr="0" alpha="1">
        ...
        <layer class="LinePatternFill" pass="0" enabled="1" locked="0">
          ...
          <symbol clip_to_extent="1" name="@12@1" type="line" force_rhr="0" alpha="1">
            <layer class="SimpleLine" pass="0" enabled="1" locked="0">
              <prop k="align_dash_pattern" v="0"/>
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
      ...
      <symbol clip_to_extent="1" name="13" type="fill" force_rhr="0" alpha="1">
        ...
        <layer class="LinePatternFill" pass="0" enabled="1" locked="0">
          ...
          <symbol clip_to_extent="1" name="@13@1" type="line" force_rhr="0" alpha="1">
            <layer class="SimpleLine" pass="0" enabled="1" locked="0">
              <prop k="align_dash_pattern" v="0"/>
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
      ...
      <symbol clip_to_extent="1" name="14" type="fill" force_rhr="0" alpha="1">
        <layer class="LinePatternFill" pass="0" enabled="1" locked="0">
          ...
          <symbol clip_to_extent="1" name="@14@0" type="line" force_rhr="0" alpha="1">
            <layer class="SimpleLine" pass="0" enabled="1" locked="0">
              <prop k="align_dash_pattern" v="0"/>
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
        ...
        <layer class="LinePatternFill" pass="0" enabled="1" locked="0">
          ...
          <symbol clip_to_extent="1" name="@14@1" type="line" force_rhr="0" alpha="1">
            <layer class="SimpleLine" pass="0" enabled="1" locked="0">
              <prop k="align_dash_pattern" v="0"/>
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
      ...
      <symbol clip_to_extent="1" name="18" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="102,51,0,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol clip_to_extent="1" name="19" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" name="20" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" name="21" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="204,255,102,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol clip_to_extent="1" name="22" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" name="23" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="102,255,0,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol clip_to_extent="1" name="24" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="102,204,51,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol clip_to_extent="1" name="25" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="102,153,51,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol clip_to_extent="1" name="26" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" name="27" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" name="28" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" name="29" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" name="30" type="fill" force_rhr="0" alpha="1">
        ...
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="255,255,102,255"/>
          <prop k="line_style" v="solid"/>
      ...
      <symbol clip_to_extent="1" name="31" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" name="32" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" name="33" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="102,102,51,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol clip_to_extent="1" name="34" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" name="35" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" name="36" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="153,204,204,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol clip_to_extent="1" name="37" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="102,153,153,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol clip_to_extent="1" name="38" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="51,102,102,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol clip_to_extent="1" name="5" type="fill" force_rhr="0" alpha="1">
        <layer class="SimpleFill" pass="0" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="255,153,102,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="&quot;artcode&quot;" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="aussage" type="field" width="474" hidden="0"/>
      <column name="thema" type="field" width="-1" hidden="0"/>
      <column name="sub_thema" type="field" width="290" hidden="0"/>
      ...
      <column name="metadatengeobasisdaten" type="field" width="41" hidden="0"/>
