...
<qgis labelsEnabled="0" simplifyAlgorithm="0" maxScale="0" simplifyLocal="1" simplifyDrawingHints="1" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" minScale="100000000" styleCategories="AllStyleCategories" version="3.16.5-Hannover">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" type="RuleRenderer" symbollevels="0">
    <rules key="{45c6943a-2b6b-4918-a69a-168f809cc0d8}">
      <rule symbol="0" key="{da6f07c7-47a5-4ae4-bb98-6d826920b2ac}" filter="&quot;artcode&quot; = 'gewaesserraum'" label="Gewässerraum"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" force_rhr="0" type="fill" alpha="1" name="0">
        <layer enabled="1" class="SimpleFill" pass="0" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="221,235,247,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="255,204,35,255"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;artcode&quot;" sortOrder="1">
    <columns>
      ...
      <column hidden="0" width="203" type="field" name="thema"/>
