...
<qgis simplifyDrawingHints="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="0" labelsEnabled="1" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" version="3.16.5-Hannover" simplifyAlgorithm="0" simplifyDrawingTol="1">
  <flags>
  ...
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="RuleRenderer">
    <rules key="{3ba25132-e4de-47d7-87d9-45e48a5ceb8e}">
      <rule key="{5364eb01-c5fc-4a82-833d-c120da841c9b}" label="Perimeter kantonaler Nutzungsplan" symbol="0" filter="substr(&quot;artcode&quot;, 1, 3) = '610'"/>
      <rule key="{1e5a550d-b85c-4423-aa12-b0100d1aef94}" label="Perimeter kommunaler Gestaltungsplan" symbol="1" filter="substr(&quot;artcode&quot;, 1, 3) = '611'"/>
      <rule key="{424ce0e7-1956-4c9e-80f2-dcb46d98f0bf}" label="Perimeter Gestaltungsplanpflicht" symbol="2" filter="substr(&quot;artcode&quot;, 1, 3) = '620'"/>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" name="1" type="fill" force_rhr="0" alpha="0.75">
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          <prop k="align_dash_pattern" v="0"/>
      ...
      <symbol clip_to_extent="1" name="2" type="fill" force_rhr="0" alpha="0.75">
        <layer class="MarkerLine" pass="1" enabled="1" locked="0">
          ...
          <symbol clip_to_extent="1" name="@2@0" type="marker" force_rhr="0" alpha="0.75">
  ...
  <aliases>
    ...
    <alias index="12" name="" field="artcode"/>
    <alias index="13" name="" field="artcodeliste"/>
    <alias index="14" name="" field="dokumente"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" notnull_strength="0" field="dokumente" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" field="dokumente" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="aussage" type="field" width="307" hidden="0"/>
      <column name="thema" type="field" width="-1" hidden="0"/>
      <column name="sub_thema" type="field" width="427" hidden="0"/>
