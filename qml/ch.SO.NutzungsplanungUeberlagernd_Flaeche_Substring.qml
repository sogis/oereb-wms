...
<qgis simplifyDrawingHints="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" labelsEnabled="1" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" version="3.16.5-Hannover" simplifyAlgorithm="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="1" type="RuleRenderer">
    <rules key="{eda0a8dc-fdb5-46d4-a18d-0b82788bc5dc}">
      ...
      <rule key="{492d311d-0947-428c-9b53-50251662849f}" label="erhaltenswertes Kulturobjekt" symbol="16" filter="substr(&quot;artcode&quot;,1,3) = 823"/>
      <rule key="{b2f92f73-5d71-400c-a819-a83a31f0e263}" label="schützenswertes Kulturobjekt" symbol="17" filter="substr(&quot;artcode&quot;,1,3) = 822"/>
    </rules>
    <symbols>
