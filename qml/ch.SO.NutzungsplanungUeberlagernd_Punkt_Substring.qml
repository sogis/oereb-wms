...
<qgis labelsEnabled="0" readOnly="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyMaxScale="1" maxScale="0" version="3.16.6-Hannover" minScale="100000000" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyAlgorithm="0">
  ...
  <renderer-v2 type="RuleRenderer" enableorderby="0" forceraster="0" symbollevels="0">
    ...
    <symbols>
      ...
      <symbol force_rhr="0" type="marker" name="3" clip_to_extent="1" alpha="1">
        <layer pass="0" enabled="1" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format autoWrapLength="0" multilineAlign="3" leftDirectionSymbol="&lt;" placeDirectionSymbol="0" rightDirectionSymbol=">" formatNumbers="0" plussign="0" reverseDirectionSymbol="0" wrapChar="" useMaxLineLengthForAutoWrap="1" decimals="3" addDirectionSymbol="0"/>
      <placement lineAnchorPercent="0.5" layerType="PointGeometry" lineAnchorType="0" placementFlags="10" polygonPlacementFlags="2" distUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGeneratorEnabled="0" yOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" distMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" rotationAngle="0" centroidInside="0" quadOffset="4" geometryGeneratorType="PointGeometry" priority="5" repeatDistanceUnits="MM" geometryGenerator="" dist="1" placement="6" centroidWhole="0" preserveRotation="1" offsetType="1" repeatDistance="0" overrunDistance="0" fitInPolygonOnly="0" xOffset="0" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM"/>
