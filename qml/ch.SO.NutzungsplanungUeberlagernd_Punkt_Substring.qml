...
<qgis simplifyDrawingHints="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" labelsEnabled="1" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0" version="3.16.5-Hannover" simplifyAlgorithm="0" simplifyDrawingTol="1">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="RuleRenderer">
    <rules key="{4f8ea2a5-dd2d-48d0-9c4c-55147a6beee7}">
      <rule key="{e0a03100-47d6-41ae-b06a-442930ee5e07}" label="erhaltenswerter Einzelbaum" symbol="0" filter="substr(&quot;artcode&quot;,1,3) = 811"/>
      <rule key="{b5d44db3-2114-44de-b239-14e2ea838064}" label="schützenswertes Kulturobjekt" symbol="1" filter="substr(&quot;artcode&quot;,1,3) = 822"/>
      <rule key="{5869ab15-47a2-47c1-bee6-2efad19eb230}" label="erhaltenswertes Kulturobjekt" symbol="2" filter="substr(&quot;artcode&quot;,1,3) = 823"/>
      <rule key="{61ac1ad2-6783-4d71-878f-7847c0b13334}" label="weitere punktbezogene Festlegungen NP" symbol="3" filter="substr(&quot;artcode&quot;,1,3) = 899"/>
    </rules>
    <symbols>
