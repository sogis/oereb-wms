...
<qgis hasScaleBasedVisibilityFlag="0" maxScale="0" styleCategories="Symbology|Fields|Rendering" simplifyDrawingTol="1" minScale="1e+8" simplifyAlgorithm="0" version="3.4.12-Madeira" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingHints="1">
  <renderer-v2 enableorderby="0" symbollevels="1" type="RuleRenderer" forceraster="0">
    <rules key="{eda0a8dc-fdb5-46d4-a18d-0b82788bc5dc}">
      <rule filter="substr(&quot;artcode&quot;,1,3) = 523" key="{79f7dd8c-2a57-4efe-ba4c-c3e98e0729b3}" label="Landschaftsschutzzone" symbol="0"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 526" key="{9f330c67-5f85-4eeb-adca-c37254564760}" label="kantonale Landwirtschafts- und Schutzzone Witi" symbol="1"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 527" key="{ece65456-2719-45d4-92af-d13f5ca9cd0c}" label="kantonale Uferschutzzone" symbol="2"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 528" key="{1b077907-7f17-46a3-a54e-c7064570e4fc}" label="kommunale Uferschutzzone ausserhalb Bauzonen" symbol="3"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 529" key="{43ae528e-5cee-4a21-8bd7-11838f3d6510}" label="weitere Schutzzonen für Lebensräume und Landschaften" symbol="4"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 590" key="{9b77eeda-2a18-4767-a04e-5413a48ba7b5}" label="Hofstattzone / Freihaltezone" symbol="5"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 591" key="{033719c8-7d83-4e32-a16b-79e78cf980c1}" label="Bauliche Einschränkungen" symbol="6"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 599" key="{6924b878-48c7-46b1-9a18-ac86e6479169}" label="weitere überlagernde Nutzungszonen" symbol="7"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 510" key="{8f502ef3-fbec-4b09-8030-b814c620bdc4}" label="überlagernde Ortsbildschutzzone" symbol="8"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 690" key="{4e91a118-efc6-444b-8d3f-2092afc6dd2b}" label="kantonales Vorranggebiet Natur und Landschaft" symbol="9"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 691" key="{56f8acb1-604b-49b8-aca1-50052dc3fda4}" label="kommunales Vorranggebiet Natur und Landschaft" symbol="10"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 692" key="{60dc05c4-58ce-46ef-9791-2ab26adade6c}" label="Planungszone" symbol="11"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 699" key="{3b3f662e-56d2-4720-82ba-813f9bf4a9db}" label="weitere flächenbezogene Festlegungen NP" symbol="12"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 823" key="{492d311d-0947-428c-9b53-50251662849f}" label="erhaltenswertes Kulturobjekt" symbol="13"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 822" key="{b2f92f73-5d71-400c-a819-a83a31f0e263}" label="schützenswertes Kulturobjekt" symbol="14"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 813" key="{85a1e06f-2036-42ae-bc67-5b1f2f05908e}" label="Naturobjekt" symbol="15"/>
      <rule filter="substr(&quot;artcode&quot;,1,3) = 812" key="{241194ee-0cde-4b38-857a-1ee0f722daee}" label="geologisches Objekt" symbol="16"/>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="10" type="fill">
        <layer class="LinePatternFill" pass="1" locked="0" enabled="1">
          <prop k="angle" v="45"/>
          ...
          <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="@10@0" type="line">
            <layer class="SimpleLine" pass="0" locked="0" enabled="1">
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="11" type="fill">
        <layer class="LinePatternFill" pass="1" locked="0" enabled="1">
          <prop k="angle" v="45"/>
          ...
          <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="@11@0" type="line">
            <layer class="SimpleLine" pass="0" locked="0" enabled="1">
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="12" type="fill">
        <layer class="LinePatternFill" pass="1" locked="0" enabled="1">
          <prop k="angle" v="45"/>
          ...
          <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="@12@0" type="line">
            <layer class="SimpleLine" pass="0" locked="0" enabled="1">
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="13" type="fill">
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="14" type="fill">
        <layer class="SimpleFill" pass="0" locked="0" enabled="1">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="15" type="fill">
        <layer class="SimpleFill" pass="0" locked="0" enabled="1">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="16" type="fill">
        <layer class="SimpleFill" pass="0" locked="0" enabled="1">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="2" type="fill">
        <layer class="PointPatternFill" pass="1" locked="0" enabled="1">
          ...
          <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="@2@0" type="marker">
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="3" type="fill">
        <layer class="PointPatternFill" pass="1" locked="0" enabled="1">
          ...
          <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="@3@0" type="marker">
            <layer class="SimpleMarker" pass="0" locked="0" enabled="1">
              <prop k="angle" v="0"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="4" type="fill">
        <layer class="LinePatternFill" pass="2" locked="0" enabled="1">
          <prop k="angle" v="45"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="7" type="fill">
        <layer class="LinePatternFill" pass="1" locked="0" enabled="1">
          <prop k="angle" v="45"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="8" type="fill">
        <layer class="LinePatternFill" pass="1" locked="0" enabled="1">
          <prop k="angle" v="45"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" name="9" type="fill">
        <layer class="SimpleLine" pass="1" locked="0" enabled="1">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
