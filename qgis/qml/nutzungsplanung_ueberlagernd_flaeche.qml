...
<qgis version="3.16.6-Hannover" styleCategories="Symbology">
  <renderer-v2 type="RuleRenderer" forceraster="0" symbollevels="1" enableorderby="0">
    <rules key="{eda0a8dc-fdb5-46d4-a18d-0b82788bc5dc}">
      <rule label="überlagernde Ortsbildschutzzone" filter="substr(&quot;artcode&quot;,1,3) = 510" symbol="0" key="{948989a4-abc0-4865-9c87-74b756e8f80f}"/>
      <rule label="Naturschutzgebiete" filter="substr(&quot;artcode&quot;,1,3) = 522" symbol="1" key="{ff95db00-e93e-4171-a636-75e2111265e8}"/>
      <rule label="Landschaftsschutzzone" filter="substr(&quot;artcode&quot;,1,3) = 523" symbol="2" key="{79f7dd8c-2a57-4efe-ba4c-c3e98e0729b3}"/>
      <rule label="kantonale Landwirtschafts- und Schutzzone Witi" filter="substr(&quot;artcode&quot;,1,3) = 526" symbol="3" key="{9f330c67-5f85-4eeb-adca-c37254564760}"/>
      <rule label="kantonale Uferschutzzone" filter="substr(&quot;artcode&quot;,1,3) = 527" symbol="4" key="{ece65456-2719-45d4-92af-d13f5ca9cd0c}"/>
      <rule label="kommunale Uferschutzzone ausserhalb Bauzonen" filter="substr(&quot;artcode&quot;,1,3) = 528" symbol="5" key="{1b077907-7f17-46a3-a54e-c7064570e4fc}"/>
      <rule label="weitere Schutzzonen für Lebensräume und Landschaften" filter="substr(&quot;artcode&quot;,1,3) = 529" symbol="6" key="{43ae528e-5cee-4a21-8bd7-11838f3d6510}"/>
      <rule label="Hofstattzone / Freihaltezone" filter="substr(&quot;artcode&quot;,1,3) = 590" symbol="7" key="{9b77eeda-2a18-4767-a04e-5413a48ba7b5}"/>
      <rule label="Bauliche Einschränkungen" filter="substr(&quot;artcode&quot;,1,3) = 591" symbol="8" key="{033719c8-7d83-4e32-a16b-79e78cf980c1}"/>
      <rule label="weitere überlagernde Nutzungszonen" filter="substr(&quot;artcode&quot;,1,3) = 599" symbol="9" key="{6924b878-48c7-46b1-9a18-ac86e6479169}"/>
      <rule label="kantonales Vorranggebiet Natur und Landschaft" filter="substr(&quot;artcode&quot;,1,3) = 690" symbol="10" key="{4e91a118-efc6-444b-8d3f-2092afc6dd2b}"/>
      <rule label="kommunales Vorranggebiet Natur und Landschaft" filter="substr(&quot;artcode&quot;,1,3) = 691" symbol="11" key="{56f8acb1-604b-49b8-aca1-50052dc3fda4}"/>
      <rule label="Planungszone" filter="substr(&quot;artcode&quot;,1,3) = 692" symbol="12" key="{60dc05c4-58ce-46ef-9791-2ab26adade6c}"/>
      <rule label="weitere flächenbezogene Festlegungen NP" filter="substr(&quot;artcode&quot;,1,3) = 699" symbol="13" key="{3b3f662e-56d2-4720-82ba-813f9bf4a9db}"/>
      <rule label="geologisches Objekt" filter="substr(&quot;artcode&quot;,1,3) = 812" symbol="14" key="{216d20ca-714b-4f18-9cf4-7705e0ae01ca}"/>
      <rule label="Naturobjekt" filter="substr(&quot;artcode&quot;,1,3) = 813" symbol="15" key="{2e8b073d-344b-44b6-a2c9-00815dfb191d}"/>
      <rule label="erhaltenswertes Kulturobjekt" filter="substr(&quot;artcode&quot;,1,3) = 823" symbol="16" key="{492d311d-0947-428c-9b53-50251662849f}"/>
      <rule label="schützenswertes Kulturobjekt" filter="substr(&quot;artcode&quot;,1,3) = 822" symbol="17" key="{b2f92f73-5d71-400c-a819-a83a31f0e263}"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="fill" clip_to_extent="1" name="0" force_rhr="0">
        <layer pass="1" class="LinePatternFill" locked="0" enabled="1">
          <prop v="45" k="angle"/>
          ...
          <symbol alpha="1" type="line" clip_to_extent="1" name="@0@0" force_rhr="0">
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="11" force_rhr="0">
        <layer pass="1" class="LinePatternFill" locked="0" enabled="1">
          ...
          <symbol alpha="1" type="line" clip_to_extent="1" name="@11@0" force_rhr="0">
            <layer pass="0" class="SimpleLine" locked="0" enabled="1">
              <prop v="0" k="align_dash_pattern"/>
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="12" force_rhr="0">
        <layer pass="1" class="LinePatternFill" locked="0" enabled="1">
          ...
          <symbol alpha="1" type="line" clip_to_extent="1" name="@12@0" force_rhr="0">
            <layer pass="0" class="SimpleLine" locked="0" enabled="1">
              <prop v="0" k="align_dash_pattern"/>
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="13" force_rhr="0">
        <layer pass="1" class="LinePatternFill" locked="0" enabled="1">
          ...
          <symbol alpha="1" type="line" clip_to_extent="1" name="@13@0" force_rhr="0">
            <layer pass="0" class="SimpleLine" locked="0" enabled="1">
              <prop v="0" k="align_dash_pattern"/>
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="4" force_rhr="0">
        <layer pass="1" class="PointPatternFill" locked="0" enabled="1">
          ...
          <symbol alpha="1" type="marker" clip_to_extent="1" name="@4@0" force_rhr="0">
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="5" force_rhr="0">
        <layer pass="1" class="PointPatternFill" locked="0" enabled="1">
          ...
          <symbol alpha="1" type="marker" clip_to_extent="1" name="@5@0" force_rhr="0">
            <layer pass="0" class="SimpleMarker" locked="0" enabled="1">
              <prop v="0" k="angle"/>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="6" force_rhr="0">
        <layer pass="2" class="LinePatternFill" locked="0" enabled="1">
          <prop v="45" k="angle"/>
          ...
          <symbol alpha="1" type="line" clip_to_extent="1" name="@6@0" force_rhr="0">
            <layer pass="0" class="SimpleLine" locked="0" enabled="1">
              <prop v="0" k="align_dash_pattern"/>
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="7" force_rhr="0">
        <layer pass="1" class="LinePatternFill" locked="0" enabled="1">
          ...
          <symbol alpha="1" type="line" clip_to_extent="1" name="@7@0" force_rhr="0">
            <layer pass="0" class="SimpleLine" locked="0" enabled="1">
              <prop v="0" k="align_dash_pattern"/>
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="8" force_rhr="0">
        <layer pass="1" class="LinePatternFill" locked="0" enabled="1">
          ...
          <symbol alpha="1" type="line" clip_to_extent="1" name="@8@0" force_rhr="0">
            <layer pass="0" class="SimpleLine" locked="0" enabled="1">
              <prop v="0" k="align_dash_pattern"/>
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
      ...
      <symbol alpha="1" type="fill" clip_to_extent="1" name="9" force_rhr="0">
        <layer pass="1" class="LinePatternFill" locked="0" enabled="1">
          ...
          <symbol alpha="1" type="line" clip_to_extent="1" name="@9@0" force_rhr="0">
            <layer pass="0" class="SimpleLine" locked="0" enabled="1">
              <prop v="0" k="align_dash_pattern"/>
              <prop v="square" k="capstyle"/>
              <prop v="5;2" k="customdash"/>
