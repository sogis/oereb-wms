...
<qgis hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" minScale="1e+08" labelsEnabled="1" simplifyLocal="1" version="3.4.13-Madeira" simplifyDrawingTol="1" styleCategories="AllStyleCategories" readOnly="0" simplifyMaxScale="1" maxScale="0" simplifyDrawingHints="0">
  <flags>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer">
    <rules key="{d416f74e-16e6-43bb-80fd-cf997e7dbbf5}">
      <rule symbol="0" label="geschütztes historisches Kulturdenkmal" key="{9e056680-af17-42f7-b417-2219735d8374}"/>
    </rules>
    <symbols>
  ...
  <labeling type="simple">
    <settings>
      ...
      <text-format wrapChar="" autoWrapLength="0" rightDirectionSymbol=">" reverseDirectionSymbol="0" formatNumbers="0" leftDirectionSymbol="&lt;" plussign="0" addDirectionSymbol="0" placeDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" multilineAlign="3" decimals="3"/>
      <placement centroidInside="0" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" placementFlags="10" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" fitInPolygonOnly="0" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" placement="6" repeatDistanceUnits="MM" preserveRotation="1" distUnits="MM" offsetType="1" maxCurvedCharAngleOut="-25" priority="5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" offsetUnits="MM" quadOffset="4" centroidWhole="0" xOffset="0" dist="1"/>
      <rendering drawLabels="1" displayAll="0" limitNumLabels="0" scaleMax="3000" maxNumLabels="2000" fontMinPixelSize="3" mergeLines="0" minFeatureSize="0" scaleVisibility="1" scaleMin="1" upsidedownLabels="0" zIndex="0" obstacleFactor="1" fontLimitPixelSize="0" labelPerPart="0" obstacleType="0" fontMaxPixelSize="10000" obstacle="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
  ...
  <DiagramLayerSettings linePlacementFlags="18" obstacle="0" placement="0" zIndex="0" showAll="1" priority="0" dist="0">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
